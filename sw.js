...
const VERSION = 'serveup-v1-1.0.0-4';
const SHELL = `${VERSION}-shell`;
const CONTENT = `${VERSION}-content`;
const shellFiles = ['v1.html','v1-admin.html','v1-certificate.html','offline.html','v1.css?v=1.0.0-4','v1.js?v=1.0.0-4','v1-admin.js?v=1.0.0-4','v1-store.js?v=1.0.0-4','quiz-core.js','environment.js?v=1.0.0-4','supabase-client.js?v=1.0.0-4','pwa.js','manifest.webmanifest','icons/serveup-192.png','icons/serveup-512.png','icons/serveup-maskable-192.png','icons/serveup-maskable-512.png'];
